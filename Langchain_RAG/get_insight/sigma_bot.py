...
def main():
    ...
    {context}<|im_end|>\n<|im_start|>user\n{question}<|im_end|>\n<|im_start|>assistant"""
    # template = """<|im_start|>system\nUse the following information to answer the question. If you don't know the answer, say you don't know, and don't attempt to make up an answer.\n
    # {context}<|im_end|>\n<|im_start|>user\n{question}<|im_end|>\n<|im_start|>assistant"""
    ...
    question = "Explain aggtext in sigma?"
